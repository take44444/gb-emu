use crate::{
  cpu::{
    Cpu,
    operand::{Cond, Reg8, Imm8, Indirect, Direct8, Reg16, Imm16, Direct16},
  },
...
impl Cpu {
  pub fn decode(&mut self, bus: &mut Peripherals) {
    ...
    match self.ctx.opcode {
      ...
      0x09 => self.add_hl_rr(bus, Reg16::BC),
      0x19 => self.add_hl_rr(bus, Reg16::DE),
      0x29 => self.add_hl_rr(bus, Reg16::HL),
      0x39 => self.add_hl_rr(bus, Reg16::SP),
